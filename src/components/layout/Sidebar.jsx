...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-white/10 flex flex-col h-screen sticky top-0">
      {/* Logo */}
      ...
      <div className="px-6 py-4 border-b border-white/10">
        ...
        <div className="text-zinc-400 text-xs tracking-widest uppercase mt-1">
          {weekday}
        </div>
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        <p className="text-zinc-600 text-xs tracking-widest uppercase px-6 mb-2">
          Menu
        </p>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-6 py-2.5 text-sm font-medium transition border-l-2 ${
                isActive
                  ? "text-[var(--color-primary)] bg-[rgba(var(--color-primary-rgb),0.1)] border-[var(--color-primary)]"
                  : "text-zinc-400 hover:text-white hover:bg-zinc-800 dark:hover:bg-zinc-800 border-transparent"
              }`
            }
          >
